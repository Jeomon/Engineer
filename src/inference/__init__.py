...
Integrate the JSON output as part of the structured response, ensuring it strictly follows the provided JSON schema.
```json
{json_schema}
```
If there is code or script output, make sure it inside the JSON adheres to the following formatting guidelines:
1. Escape Newlines: `\n` should be `\n`.
